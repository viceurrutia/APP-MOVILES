...
class MainActivity: AppCompatActivity(){
 ...
 val offers=listOf(
  Game(101,"Zelda TOTK","$59.990","zelda","Explora Hyrule."),
  Game(102,"Elden Ring","$49.990","eldenring","Mundo abierto.")
 )
 val catalog=listOf(
  Game(101,"Zelda TOTK","$59.990","zelda","Explora Hyrule."),
  Game(102,"Elden Ring","$49.990","eldenring","Mundo abierto."),
  Game(103,"Super Mario","$39.990","mario","Plataformas."),
  Game(104,"Spider-Man 2","$59.990","spiderman","Acción."),
  Game(105,"Cyberpunk 2077","$29.990","cyberpunk","RPG futurista.")
 )
